            ...
            <div class="w-70 mx-auto md:mx-0 md:mr-5">
                ...
                >
                    ...
                    @auth
                        ...
                        @else
                        <div class="my-6 text-center flex items-center flex-col">
                            <a
                                href="{{ route('login') }}"
                            ...
                            <a
                                href="{{ route('register') }}"
                                class="justify-center w-1/2 h-11 text-xs bg-gray-200 font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3 mt-2"
                                >
